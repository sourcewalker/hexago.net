    ...
    public class BasicAuthenticationAttribute : AuthorizationFilterAttribute
    {
        ...
        public override void OnAuthorization(HttpActionContext actionContext)
        {
            ...
            if (authHeader != null)
            {
                ...
                if ((ConfigurationManager.AppSettings["BasicAuth:Proximity:Key"] == key &&
                    ConfigurationManager.AppSettings["BasicAuth:Proximity:Password"] == password) ||
                    (ConfigurationManager.AppSettings["BasicAuth:System:Key"] == key &&
                    ConfigurationManager.AppSettings["BasicAuth:System:Password"] == password) ||
                    (ConfigurationManager.AppSettings["BasicAuth:External:Key"] == key &&
                    ConfigurationManager.AppSettings["BasicAuth:External:Password"] == password))
                {
                    currentUser = key;
                    hasAccess = true;
                }
